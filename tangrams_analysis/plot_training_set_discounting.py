...
Use with e.g. "find ~/Documents/Projects/Tangrams/output/tangrams-morediscounting -iname "Training-discount*\bothspkr.tsv" -exec ./plot_training_set_discounting.py {} +"
"""
