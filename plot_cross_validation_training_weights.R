...
plot <- plot + xlab("Round") + ylab("MRR") + theme_light() + theme(text=element_text(family="Times"), aspect.ratio=1, plot.margin=margin(0,0,0,0), legend.box.margin=margin(0,0,0,0), legend.box.spacing=unit(1, "mm"), legend.margin=margin(0,0,0,0)) 
